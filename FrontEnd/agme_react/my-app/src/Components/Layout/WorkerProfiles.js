  ...
  async componentDidMount() {
    ...
    try {
      const res = await axios.get(
        "http://localhost:8080/api/worker/all"
                  ...
                  <div class="row">
                    ...
                    value = {this.state.index} onChange={this.handleChange}  required>
                        ...
                        
                      {
                        ...
                        <h6>Please select a worker to view their profile</h6>
                        
                                           }  
                          <div className='link-redirect-wpp'>
                            <Link to="/Booking">
                               <h6>Go back to bookings page</h6>
                            </Link>
                          </div>                              
                      </div>
                    </div>
                ...
                <div className="card" data-test="card">
                  ...
                  <div class="row">
                    ...
                    <div className="card-content"></div>
                      ...
                      <div className='link-redirect-wp'>
                        <Link to="/Booking">
                          <h6>Go back to bookings page</h6>
                        </Link>
                      </div>
